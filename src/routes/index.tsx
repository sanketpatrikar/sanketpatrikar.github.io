					...
					<div className="flex flex-col gap-2">
						...
						<div className="mt-3 flex flex-nowrap justify-center gap-3 whitespace-nowrap text-[clamp(0.75rem,3.8vw,1rem)] text-[#3b82b6] sm:justify-start sm:text-lg">
							...
							<a
								...
								className="group relative inline-flex items-center rounded-full py-1.5 transition hover:bg-[#e4f2fa] hover:text-[#2c668f] sm:px-3"
							>
								Email{" "}
								<span
									aria-hidden="true"
									className="absolute left-full ml-0.5 opacity-0 transition-opacity group-hover:opacity-100 group-focus-visible:opacity-100"
								>
									↗
								</span>
							</a>
